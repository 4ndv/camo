...
(function() {
  var Fs, Http, Https, Path, QueryString, Url, accepted_image_mime_types, camo_hostname, content_length_limit, current_connections, debug_log, default_security_headers, error_log, finish, four_oh_four, keep_alive, logging_enabled, max_redirects, port, process_url, server, socket_timeout, started_at, total_connections, version,
  ...
  server = Http.createServer(function(req, resp) {
    var base, dest_url, encoded_url, fullpath, prefix, ref, ref1, transferredHeaders, url, url_type, user_agent;
